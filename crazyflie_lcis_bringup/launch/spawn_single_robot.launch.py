...
from crazyflie_lcis.bridge_config import generate_bridge_config_file
from crazyflie_lcis.initial_position import generate_random_positions
...
def generate_launch_description():
    ...
    pkg_crazyflie_lcis_description_path = get_package_share_directory("crazyflie_lcis_description") # use for model description
